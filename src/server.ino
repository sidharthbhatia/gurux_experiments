...
void setup() {
  ...
  //Added EEPROM_SIZE
  GXTRACE_INT(PSTR("EEPROM size"), EEPROM_SIZE);
...
void loop() {
  ...
  {
    Serial2.println("Starting server run");
    Serial2.printf("executeTime before Server.run = %lu\n", executeTime);
    Serial2.printf("start before Server.run = %lu\n", start);
    Server.run(start, &executeTime);
    Serial2.printf("executeTime after Server.run = %lu\n", executeTime);
    Serial2.printf("start after Server.run = %lu\n", start);
  }
